...
public class Logger {
    ...
    private static void sendLogItem(@NotNull LogItem logItem) {
...
//                switch (logDestination) {
//                    case FILE:
//                        WriteFile.writeLogInfo(logItem.toString());
//                        break;
//                    case CONSOLE:
//                        System.out.println(TextColor.BLUE.getColor() + logItem.toString() + TextColor.RESET.getColor());
//                        break;
//                    case CONSOLE_AND_FILE:
//                        System.out.println(TextColor.BLUE.getColor() + logItem.toString() + TextColor.RESET.getColor());
//                        WriteFile.writeLogInfo(logItem.toString());
...
//                switch (logDestination) {
//                    case FILE:
//                        WriteFile.writeLogWarn(logItem.toString());
//                        break;
//                    case CONSOLE:
//                        System.out.println(TextColor.BLUE.getColor() + logItem.toString() + TextColor.RESET.getColor());
//                        break;
...
//                switch (logDestination) {
//                    case FILE:
//                        WriteFile.writeLogError(logItem.toString());
//                        break;
//                    case CONSOLE:
//                        System.out.println(TextColor.BLUE.getColor() + logItem.toString() + TextColor.RESET.getColor());
//                        break;
...
//                switch (logDestination) {
//                    case FILE:
//                        WriteFile.writeLogFatal(logItem.toString());
//                        break;
//                    case CONSOLE:
//                        System.out.println(TextColor.BLUE.getColor() + logItem.toString() + TextColor.RESET.getColor());
//                        break;
